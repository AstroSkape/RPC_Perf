...
import (
	"SSP_Project/thrift-async/gen-go/tutorial"
	"context"
	"strconv"
	"strings"
)
...
func (p *Handler) Multiply(ctx context.Context, A string, B string, m1 tutorial.Int, n1 tutorial.Int, m2 tutorial.Int, n2 tutorial.Int) (err error) {
